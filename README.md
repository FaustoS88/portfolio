...
The deploy script automatically builds the React app into the `dist` folder and pushes it to the `gh-pages` branch. The live site reflects at `https://[username].github.io/portfolio/`.
